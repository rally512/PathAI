...
export default function TravelScheduleScreen() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.headerRow}>
        <Text style={styles.title}>Travel Schedule (Setup)</Text>
...
const styles = StyleSheet.create({
  ...
  addButton: { fontSize: 28, color: '#007AFF', marginRight: 4 },
  sectionHeader: {
    fontSize: 16,
    fontWeight: '600',
    marginTop: 10,
  ...
  itemTime: { fontSize: 14, color: '#666', marginTop: 4 },
  itemLocation: { fontSize: 13, color: '#888', marginTop: 2 },
  doneButton: {
